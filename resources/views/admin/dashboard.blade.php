...
<div style="padding:25px;" class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div style="margin-top:150px;" class="panel panel-info">
          ...
          <div class="panel-body">
            <a class="underline" href="{{ route('admin.get.questions') }}">
                <h1>{{ $total['questions'] }} Questions</h1>
            </a>
            <a class="underline" href="{{ route('admin.get.questions') }}?search=true&status=pending">
                <h2 style="color:#337ab7;">{{ $total['pending-questions'] }} Pending</h2>
            </a>
            <a class="underline" href="{{ route('admin.get.questions') }}?search=true&status=approved">
                <h2 style="color:#449d44;">{{ $total['approved-questions'] }} Approved</h2>
            </a>
            <a class="underline" href="{{ route('admin.get.questions') }}?search=true&status=rejected">
