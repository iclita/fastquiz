        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 bootcards-list">
          ...
          <div class="panel panel-default material-box">
            ...
            <div class="panel-body">
              <form method="GET" action="{{ route('admin.get.questions') }}">
                ...
                <div style="margin-top:15px;" class="row">
                  <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                    <div class="form-group">
                      {!! Form::select('category', categories(), Request::input('category', ''), ['class'=>'form-control material-box', 'placeholder' => trans('question.all_categories')]) !!}
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                    <div class="form-group">
            ...
            <div class="list-group">
              ...
              <div style="position:relative;">
                ...
                @if ($index === 0)
                <a style="min-height:85px; padding-top:20px;" class="list-group-item active show-question"
                  data-id="{{ $question->id }}" 
                ...
                @else
                <a style="min-height:85px; padding-top:20px;" class="list-group-item show-question" 
                  data-id="{{ $question->id }}" 
                  data-description="{{ $question->description }}" 
                  data-category="{{ $question->getCategoryName() }}" 
                  data-answer="{{ $question->getAnswer() }}" 
                ...
                <div class="change-status">                    
                  <a class="btn btn-danger btn-block material-box" href="{{ route('admin.question.status', ['id' => $question->id]) }}?status=rejected">
                    <i class="fa fa-times"></i>Reject
                  </a>
                  <a class="btn btn-primary btn-block material-box" href="{{ route('admin.question.status', ['id' => $question->id]) }}?status=pending">
                    <i class="fa fa-clock-o"></i>Pending
                  </a>
                </div>
                @elseif ($question->isRejected())
                <div class="change-status"> 
                  <a class="btn btn-success btn-block material-box" href="{{ route('admin.question.status', ['id' => $question->id]) }}?status=approved">
